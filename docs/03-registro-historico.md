...
| **Setup** | Wings, Engine, Brakes, Gear, Suspension |
...
├─────────────────────────────────────────────────────────────────────────┤
│                                                                         │
│  BASE DE ORO (Tu setup):  W:52  E:700  B:345  G:155  S:68              │
│  ──────────────────────────────────────────────────────────             │
│                                                                         │
│  ┌─────────┬──────┬──────┬──────┬──────┬──────┬────────┬─────────────┐ │
│  │ Alumno  │ Wing │ Eng  │ Brk  │ Gear │ Susp │ Status │ Desviación  │ │
│  ├─────────┼──────┼──────┼──────┼──────┼──────┼────────┼─────────────┤ │
...
$$\text{Desviación} = \frac{1}{N} \sum_{i=1}^{N} \left| \frac{\text{Valor}_{alumno,i} - \text{Valor}_{base,i}}{\text{Valor}_{base,i}} \right| \times 100$$

Donde $N$ es el número de componentes del setup (Wings, Engine, Brakes, Gear, Suspension).
